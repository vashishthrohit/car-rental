<x-header title="Home"></x-header>
      ...
      <div class="hero" style="background-image: url('assets/images/all_img/hero_1_a.jpg');">          
          <div class="container">
          ...
          <div class="row align-items-center">
            <div class="col-lg-7 text-center order-lg-2">
              <div class="img-wrap-1 mb-5">
                <img src="{{url('assets/images/all_img/feature_01.png')}}" alt="Image" class="img-fluid">
              </div>
            </div>
